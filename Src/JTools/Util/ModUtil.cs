...
namespace TierneyJohn.MiChangSheng.JTools.Util
{
    ...
    public static class ModUtil
    {
        ...
        public static bool CheckModActive(this ulong steamId)
        {
            return CheckModActive(steamId.ToString());
        }
        ...
        {
            return WorkshopTool.GetAllModDirectory().Where(directory => directory.Name.Equals(steamId))
                .Any(directory => !WorkshopTool.CheckModIsDisable(steamId));
        }
