...
/// </summary>
[Serializable]
public class JAfterFight : SetSTalk
{
    #region 字段/属性
    ...
    /// <returns>JAfterFight 对象</returns>
    public JAfterFight Create(string callBlockName, string callFlowchartName = "")
    {
        // 固定识别编号
        TalkID = 444;
    ...
    /// <returns>JAfterFight 对象</returns>
    public JAfterFight Create(Block callBlock, Flowchart callFlowchart = null)
    {
        // 固定识别编号
        TalkID = 444;
    ...
    {
        FungusManager.Inst.RegisterAfterFightData(TargetFlowchart, TargetBlock);
        base.OnEnter();
    }
